...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the node to remove is the head, then we can call RemoveHead
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the node to remove is the tail, then we can call RemoveTail
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // For any other location of 'value', need to reconnect the links to remove.
                else
                {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue; // Replace the value in the node
            }
